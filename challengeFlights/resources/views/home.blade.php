...
{{--    <div id='app' >--}}
{{--        <flight-component flights="$flights"> </flight-component>--}}
{{--    </div>--}}
...
{{--                    </tr>--}}
{{--                    </thead>--}}
{{--                    <flights-component v-for="flight in flights">{{flight}}</flights-component>--}}
...
{{--<script>--}}
{{--    import Flights from "../admins/flights.html";--}}
{{--    export default {--}}
{{--        components: {Flights}--}}
{{--    }--}}
{{--</script>--}}
