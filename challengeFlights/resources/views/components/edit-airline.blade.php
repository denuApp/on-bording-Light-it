...
{{--                    <button type="button" @click="show = false" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="authentication-modal">--}}
{{--                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>--}}
{{--                    </button>--}}
{{--                </div>--}}
{{--                <form method="POST" action="/edit-airline/{{$airline->id}}" class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" >--}}
{{--                    @csrf--}}
{{--                    @method('PATCH')--}}
{{--                    <h3 class="text-white text-xl text-align-left font-bold ml-2 uppercase">Edit Airline</h3>--}}
        ...
        <div class="relative bg-gray-300 rounded-lg shadow ">
            ...
            <div class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" >
                ...
                <button type="submit"
                        ...
                        class="update_airline transition-colors duration-300 bg-purple-500 hover:bg-blue-600 mt-4 lg:mt-0 right-aligned rounded-full text-xs font-semibold text-white uppercase py-3 px-8"
                >
                    Make changes
                </button>
            </div>
