                ...
                <div class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8">
                    ...
                    <div class="  mb-6 bg-gray-200 rounded-full">
                        <div class="lg:py-3 lg:px-5 flex items-center">
                            ...
                            <input id="name_create" type="text" name="name" required placeholder="City name"
                    ...
                    <button type="submit"
                            class=" add_city transition-colors duration-300 bg-purple-500 hover:bg-blue-600 mt-4 lg:mt-0 right-aligned rounded-full text-xs font-semibold text-white uppercase py-3 px-8"
                    >
                        Add
                    </button>
                </div>
